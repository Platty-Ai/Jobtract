...
@app.route('/api/projects/upload-photo', methods=['POST'])
@require_auth
...
@app.route('/api/quotes/upload-photo', methods=['POST'])
@require_auth
...
@app.route('/api/quotes/<path:quote_id>', methods=['DELETE'])
@require_auth
...
@app.route('/api/equipment/upload-photo', methods=['POST'])
@require_auth
...
@app.route('/api/expenses/upload-photo', methods=['POST'])
@require_auth
...
@app.route('/api/tank-deposits/<deposit_id>', methods=['PUT'])
@require_auth
...
@app.route('/api/tank-deposits/<deposit_id>', methods=['DELETE'])
@require_auth
...
@app.route('/api/tank-deposits/upload-photo', methods=['POST'])
@require_auth
...
@app.route('/api/purchase-orders/<path:po_id>', methods=['PUT'])
@require_auth
...
@app.route('/api/purchase-orders/<path:po_id>', methods=['DELETE'])
@require_auth
...
@app.route('/api/purchase-orders/upload-photo', methods=['POST'])
@require_auth
